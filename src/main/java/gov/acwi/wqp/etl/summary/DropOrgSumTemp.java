...
@Component
@StepScope
public class DropOrgSumTemp implements Tasklet {

	private final JdbcTemplate jdbcTemplate;

	@Autowired
	public DropOrgSumTemp(JdbcTemplate jdbcTemplate) {
	...
	public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
		try {
			jdbcTemplate.update("drop table org_sum_temp_storet cascade constraints purge");
